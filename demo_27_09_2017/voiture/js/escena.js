...
(function(){
	...
	SERIOUSGAME.viewer={
		...
		"init":function(elementId,params){
			...
			var width = Math.min(1920,window.screen.width);
			var height = Math.min(1080,window.screen.height);
						
			scene = new THREE.Scene(); 
			camZero = new THREE.PerspectiveCamera(65,width/height, 0.1, 1000000); 			
